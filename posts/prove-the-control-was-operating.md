...
cover: ./posts/images/evidence-demo-cover.jpg
---
...
![FastAIAgent Enterprise binding EU AI Act obligations to live runtime evidence](/posts/videos/eu-ai-act-evidence-demo.mp4 "Sixty seconds: compliance violations, dark agents and missing eval evidence surfaced from what the agents actually did.")

The longer argument behind this demo is in [Evidence, not attestation](/blog/evidence-not-attestation/) — why an auditor wants the record that a control ran, not a signed claim that it exists. The [Enterprise page](/enterprise.html) covers the governance layer in full.
